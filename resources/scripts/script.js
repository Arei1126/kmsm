...
let stDefault = new situation("デフォルト","人間の声が聞こえるぞ。質問だ。お前の夢は何だ。耳に向かって話しかけてくれ。さん、にい、いち、どうぞ。","うん、それで","ありがとう、人間。またね。");
...
let stLafore = new situation("ラフォレ","人間の声が聞こえるぞ。質問だ。お前は今日はどんなものを食べるんだ？耳に向かって話かけてくれ。さん、にい、いち、どうぞ。","うん、それで","ありがとう。人間、またね。");
Situations.push(stLafore);

let stLaforeAfter = new situation("ラフォレ食後","人間の声が聞こえるぞ。質問だ。お前は今日は何を食べたのだ？耳に向かって話かけてくれ。さん、にい、いち、どうぞ。","うん、それで","ありがとう。人間、またね。");
Situations.push(stLaforeAfter);


let stLibrary = new situation("図書館","人間の声が聞こえるぞ。質問だ。お前は今日は何をしに図書館に来たんだ？耳に向かって話しかけてくれ。さん、にい、いち、どうぞ。","うん、それで","ありがとう、人間。またね。");
Situations.push(stLibrary);
let stNamiko = new situation("浪高庭園","人間の声が聞こえるぞ。質問だ。お前は、暇なとき何をしているんだ。耳に向かって話しかけてくれ。さん、にい、いち、どうぞ。","うん、それで","ありがとう、人間。またね。");

Situations.push(stNamiko);
let stMain = new situation("メインストリート","人間の声が聞こえるぞ。質問だ。お前は、暇なとき何をしているんだ。耳に向かって話しかけてくれ。さん、にい、いち、どうぞ。","うん、それで","ありがとう、人間。またね。");
Situations.push(stMain);
let stShop = new situation("商店街","人間の声が聞こえるぞ。質問だ。この商店街のおすすめの店を教えてほしい。耳に向かって話しかけてくれ。さん、にい、いち、どうぞ。","うん、それで","ありがとう、人間。またね。");
Situations.push(stShop);

let stKogaku = new situation("工学部付近","人間の声が聞こえるぞ。質問だ。お前は暇なとき何をしているんだ。耳に向かって話しかけてくれ。さん、にい、いち、どうぞ。","うん、それで","ありがとう、人間。またね。");
